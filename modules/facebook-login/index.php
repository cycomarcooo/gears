    ...
    class GearsModulesFacebookLogin {
        ...
        public function custom_error_message(){
            ...
            if( isset( $_GET['error'] ) and isset( $_GET['type'] ) ){
                ...
                if( $_GET['type'] == 'gears_user_not_allowed' ){
                    add_filter( 'login_message', array( $this, 'error_user_not_allowed' ) );
                }
        ...
        public function error_user_not_allowed()
        {
            $errMessage = __('You\'re not allowed to connect to this site.', 'gears');
            $this->wp_error_class($errMessage);
            return;
        }
